...
bool CheckRemoteAuthorization(const bool showAlert)
{
   ...
   url += sep + "account_login=" + account + "&version=1.30R&product=XAUUSD";
...
void CreateStatusPanel()
  {
   ...
   ObjectSetString(0, OBJ_HEADER, OBJPROP_TEXT, "金貔貅 v1.30R");
...
double GetMartSpacingLayerFactor()
  {
   ...
   if(layer <= 3)  return 0.50;
   if(layer <= 6)  return 0.75;
   if(layer <= 9)  return 1.00;
   if(layer <= 12) return 1.35;
   if(layer <= 15) return 1.75;
   return 2.30;
  }

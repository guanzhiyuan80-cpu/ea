...
void SetSpeedMode(int mode)
{
   ...
   PrintFormat("[速度切换] 模式=%s | ATR系数=%.4f(基准%.2f) EMA入场阈值=%d",
...
bool CheckRemoteAuthorization(const bool showAlert)
{
   ...
   url += sep + "account_login=" + account + "&version=1.61R&product=XAUUSD";
...
void CreateStatusPanel()
  {
   ...
   ObjectSetString(0, OBJ_HEADER, OBJPROP_TEXT, "青鸾 v1.61R");

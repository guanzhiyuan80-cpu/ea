...
bool CheckRemoteAuthorization(const bool showAlert)
{
   ...
   url += sep + "account_login=" + account + "&version=1.32R&product=XAUUSD";
...
void CreateStatusPanel()
  {
   ...
   ObjectSetString(0, OBJ_HEADER, OBJPROP_TEXT, "金貔貅 v1.32R");
...
void DestroyStatusPanel()
  {
   ...
   ObjectDelete(0, OBJ_ROT_CLOSE4); ObjectDelete(0, OBJ_ROT_CLOSE5);
